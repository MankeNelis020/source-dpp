...
export default function ReviewsPage() {
  ...
  return (
    <div className="mx-auto max-w-5xl">
      ...
      <p className="mt-1 text-[13px] text-ink/60">Are these the same supplier?</p>
      <div className="mt-4 space-y-3">
        {identity.map((item) => (
          <article key={item.id} className="border border-ink/8 bg-card p-5">
            ...
            <div className="mt-2 grid gap-4 md:grid-cols-2">
              ...
              <div>
                ...
                <p className="mt-1 text-[12px] text-ink/55">{item.meta}</p>
                <div className="mt-2">
        ...
        {identity.length === 0 ? (
          <p className="text-[13px] text-signal">Identity queue clear. No data was merged without confirmation.</p>
        ) : null}
      </div>
