    ...
    <>
      <section className="mx-auto grid max-w-6xl gap-12 px-5 py-16 md:grid-cols-2 md:items-center md:py-24">
        <div>
          ...
          <h1 className="mt-5 font-[family-name:var(--font-space)] text-[40px] font-medium leading-[1.05] tracking-[-0.03em] text-[#101A15] md:text-[64px]">
          ...
          <p className="mt-6 max-w-md text-[14.5px] leading-relaxed text-[#101A15]/70">
      ...
      <section className="border-y border-[#101A15]/8 bg-[#FBFCFA]">
        <div className="mx-auto max-w-6xl px-5 py-16">
          <h2 className="font-[family-name:var(--font-space)] text-[33px] font-medium tracking-[-0.02em]">
          ...
          <p className="mt-10 max-w-xl text-[14.5px] leading-relaxed text-[#101A15]/70">
      ...
      <section className="mx-auto max-w-6xl px-5 py-8">
        ...
        <h2 className="mt-4 max-w-xl font-[family-name:var(--font-space)] text-[33px] font-medium tracking-[-0.02em]">
          Different systems. Same supplier.
        </h2>
        <p className="mt-3 max-w-xl text-[14.5px] leading-relaxed text-[#101A15]/70">
      ...
      <section className="mt-16 bg-[#101A15] text-[#FBFCFA]">
        <div className="mx-auto grid max-w-6xl gap-12 px-5 py-20 md:grid-cols-2 md:items-center">
          <div>
            <SourceLabel className="text-[#FBFCFA]/50">For suppliers</SourceLabel>
            ...
            <p className="mt-4 text-[14.5px] leading-relaxed text-[#FBFCFA]/70">
              Suppliers can provide product evidence once and decide how it may be reused.
            </p>
            <div className="mt-8">
              <SourceButton href="/suppliers" variant="ghost" className="text-[#FBFCFA] ring-[#FBFCFA]/20">
                SOURCE for suppliers
              </SourceButton>
            </div>
          </div>
          <article className="border border-[#FBFCFA]/12 bg-[#101A15] p-6">
            <SourceLabel className="text-[#FBFCFA]/50">Recycling claim</SourceLabel>
            <div className="mt-3 font-[family-name:var(--font-space)] text-[48px] leading-none">67%</div>
            <span className="mt-2 block h-[2px] w-16 bg-[#0B6E50]" />
            <div className="mt-4">
              <StatusPill tone="signal">Evidence available</StatusPill>
            </div>
            <ul className="mt-6 space-y-2 font-[family-name:var(--font-plex)] text-[12px] text-[#FBFCFA]/75">
              <li>● Verified customers</li>
              <li className="text-[#FBFCFA]/40">○ Request access</li>
              <li className="text-[#FBFCFA]/40">○ Private</li>
            </ul>
          </article>
        </div>
      </section>
      ...
      <section className="mx-auto max-w-6xl px-5 py-20">
        <h2 className="max-w-lg font-[family-name:var(--font-space)] text-[33px] font-medium tracking-[-0.02em]">
      ...
      <section className="border-t border-[#101A15]/8">
        <div className="mx-auto max-w-6xl px-5 py-24">
          <SourceLabel>The principle</SourceLabel>
          <h2 className="mt-4 max-w-xl font-[family-name:var(--font-space)] text-[40px] font-medium leading-tight tracking-[-0.03em]">
            We never say a claim is true.
            <br />
            We show you how it&apos;s known.
          </h2>
          <p className="mt-6 max-w-lg text-[14.5px] leading-relaxed text-[#101A15]/70">
...
function Step({ n, title, children }: { n: string; title: string; children: React.ReactNode }) {
  return (
    <div>
      ...
      <h3 className="mt-2 font-[family-name:var(--font-space)] text-[20px] tracking-[-0.02em]">
        {title}
      </h3>
      <p className="mt-2 text-[13px] leading-relaxed text-[#101A15]/70">{children}</p>
    </div>
  );
}
