    ...
    <div className="mx-auto min-h-full max-w-lg px-5 py-16">
      ...
      {step === "form" ? (
        <>
          ...
          <p className="mt-1 text-[13px] text-[#101A15]/60">Used in 47 requested products.</p>
          ...
          <div className="mt-6">
            ...
            <p className="mt-2 text-[13px] text-[#101A15]/65">Upload or use existing evidence.</p>
      ...
      {step === "done" ? (
        <>
          ...
          <p className="mt-3 text-[14.5px] leading-relaxed text-[#101A15]/70">
          ...
          {account === "skip" ? (
            <p className="mt-6 text-[13px] text-[#0B6E50]">
