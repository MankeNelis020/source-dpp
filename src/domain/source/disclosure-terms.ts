...
export const DATA_DISCLOSURE_TERMS_CATALOG: DataDisclosureTerms[] = [DATA_DISCLOSURE_TERMS_V1_DRAFT];

let currentVersion = DATA_DISCLOSURE_TERMS_V1_DRAFT.version;
...
export function resetDataDisclosureTermsForTests() {
  currentVersion = DATA_DISCLOSURE_TERMS_V1_DRAFT.version;
