...
export const QUERY_MAP: { intent: string; query: string; path: string }[] = [
  ...
  { intent: "implementation", query: "how to prepare thousands of SKUs for DPP", path: "/dpp-readiness" },
  { intent: "software", query: "Digital Product Passport software", path: "/dpp-readiness" },
  { intent: "software", query: "DPP readiness software", path: "/dpp-readiness" },
  { intent: "software", query: "DPP readiness tool", path: "/digital-product-passport/dpp-readiness" },
  { intent: "software", query: "product evidence management", path: "/" },
  { intent: "software", query: "product evidence resolution", path: "/" },
  { intent: "software", query: "supplier evidence resolution", path: "/suppliers" },
  ...
  { intent: "audience", query: "DPP software for manufacturers", path: "/manufacturers" },
];
